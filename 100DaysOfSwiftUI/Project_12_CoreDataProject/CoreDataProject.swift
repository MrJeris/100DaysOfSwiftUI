...
//  100DaysOfSwiftUI
//
//  Created by MrJeris on 09.05.2023.
//
...
struct DynamicFilteringContentView: View {
    ...
    var body: some View {
        VStack {
            FilteredList(filterType: filterType, filterKey: "lastName", filterValue: lastNameFilter, sortDescriptors: sortDescriptors) { (singer: Singer) in
